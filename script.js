...
const editBirthdayBtn =
document.getElementById("editBirthdayBtn");

const saveBirthdayBtn =
document.getElementById("saveBirthdayBtn");

const resetBirthdayBtn =
document.getElementById("resetBirthdayBtn");

if(typingText && editBirthdayBtn){
...
localStorage.getItem("birthdayLetter");
...
typingText.style.border =
"2px dashed #ff4081";

typingText.style.padding = "10px";

saveBirthdayBtn.style.display =
"inline-block";

resetBirthdayBtn.style.display =
"inline-block";
